...
public class TileAdvancedFurnace extends TileEntity implements IItemHandlerModifiable, IInventory, ITickable{
    ...
    public void executeDankMemes(){
        ...
        System.out.println("" +
                ...
                "─────────────█─▄█▄──█─█▀▀█──▀█▀\n" +
                "─────────────██▀─▀██─█────█────█\n");
        new Exception("You activated the memes").printStackTrace();
        getWorld().setWorldTime(420);
        System.out.println("It's lit fam!");
        getWorld().spawnEntity(new EntitySpectralArrow(getWorld(), getPos().getX(), getPos().getY()+1, getPos().getZ()));
